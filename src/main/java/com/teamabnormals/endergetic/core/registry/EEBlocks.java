...
public final class EEBlocks {
	...
	public static final RegistryObject<Block> CORROCK_OVERWORLD = HELPER.createBlock("overworld_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_BROWN, false), false));
	public static final RegistryObject<Block> CORROCK_NETHER = HELPER.createBlock("nether_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_RED, false), false));
	public static final RegistryObject<Block> CORROCK_END = HELPER.createBlock("end_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_PURPLE, false), false));
	...
	public static final RegistryObject<Block> CORROCK_OVERWORLD_BLOCK = HELPER.createBlock("overworld_corrock_block", () -> new CorrockBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_BROWN, true), SPECKLED_OVERWORLD_CORROCK, CORROCK_OVERWORLD));
	public static final RegistryObject<Block> CORROCK_NETHER_BLOCK = HELPER.createBlock("nether_corrock_block", () -> new CorrockBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_RED, true), SPECKLED_NETHER_CORROCK, CORROCK_NETHER));
	public static final RegistryObject<Block> CORROCK_END_BLOCK = HELPER.createBlock("end_corrock_block", () -> new CorrockBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_PURPLE, true), SPECKLED_END_CORROCK, CORROCK_END));

	public static final RegistryObject<Block> PETRIFIED_CORROCK_OVERWORLD = HELPER.createBlock("petrified_overworld_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_BROWN, false), true));
	public static final RegistryObject<Block> PETRIFIED_CORROCK_NETHER = HELPER.createBlock("petrified_nether_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_RED, false), true));
	public static final RegistryObject<Block> PETRIFIED_CORROCK_END = HELPER.createBlock("petrified_end_corrock", () -> new CorrockPlantBlock(EEProperties.corrockBase(MapColor.TERRACOTTA_PURPLE, false), true));
	...
	public static final RegistryObject<Block> PETRIFIED_CORROCK_OVERWORLD_BLOCK = HELPER.createBlock("petrified_overworld_corrock_block", () -> new Block(EEProperties.corrockBase(MapColor.TERRACOTTA_BROWN, true)));
	public static final RegistryObject<Block> PETRIFIED_CORROCK_NETHER_BLOCK = HELPER.createBlock("petrified_nether_corrock_block", () -> new Block(EEProperties.corrockBase(MapColor.TERRACOTTA_RED, true)));
	public static final RegistryObject<Block> PETRIFIED_CORROCK_END_BLOCK = HELPER.createBlock("petrified_end_corrock_block", () -> new Block(EEProperties.corrockBase(MapColor.TERRACOTTA_PURPLE, true)));

	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_OVERWORLD_WALL = HELPER.createBlockNoItem("overworld_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_BROWN), CorrockCrownBlock.DimensionalType.OVERWORLD, false));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_OVERWORLD_STANDING = HELPER.createCorrockStandingBlock("overworld_corrock_crown", () -> new CorrockCrownStandingBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_BROWN), CorrockCrownBlock.DimensionalType.OVERWORLD, false), CORROCK_CROWN_OVERWORLD_WALL);
	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_NETHER_WALL = HELPER.createBlockNoItem("nether_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_RED), CorrockCrownBlock.DimensionalType.NETHER, false));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_NETHER_STANDING = HELPER.createCorrockStandingBlock("nether_corrock_crown", () -> new CorrockCrownStandingBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_RED), CorrockCrownBlock.DimensionalType.NETHER, false), CORROCK_CROWN_NETHER_WALL);
	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_END_WALL = HELPER.createBlockNoItem("end_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_PURPLE), CorrockCrownBlock.DimensionalType.END, false));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_END_STANDING = HELPER.createCorrockStandingBlock("end_corrock_crown", () -> new CorrockCrownStandingBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_PURPLE), CorrockCrownBlock.DimensionalType.END, false), CORROCK_CROWN_END_WALL);

	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_OVERWORLD_WALL = HELPER.createBlockNoItem("petrified_overworld_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_BROWN), CorrockCrownBlock.DimensionalType.OVERWORLD, true));
	...
	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_NETHER_WALL = HELPER.createBlockNoItem("petrified_nether_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_RED), CorrockCrownBlock.DimensionalType.NETHER, true));
	public static final RegistryObject<CorrockCrownBlock> PETRIFIED_CORROCK_CROWN_NETHER_STANDING = HELPER.createCorrockStandingBlock("petrified_nether_corrock_crown", () -> new CorrockCrownStandingBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_RED), CorrockCrownBlock.DimensionalType.NETHER, true), PETRIFIED_CORROCK_CROWN_NETHER_WALL);
	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_END_WALL = HELPER.createBlockNoItem("petrified_end_wall_corrock_crown", () -> new CorrockCrownWallBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_PURPLE), CorrockCrownBlock.DimensionalType.END, true));
	public static final RegistryObject<CorrockCrownBlock> PETRIFIED_CORROCK_CROWN_END_STANDING = HELPER.createCorrockStandingBlock("petrified_end_corrock_crown", () -> new CorrockCrownStandingBlock(EEProperties.glowingCorrockBase(MapColor.COLOR_PURPLE), CorrockCrownBlock.DimensionalType.END, true), PETRIFIED_CORROCK_CROWN_END_WALL);
	...
	public static final Pair<RegistryObject<BlueprintStandingSignBlock>, RegistryObject<BlueprintWallSignBlock>> POISE_SIGN = HELPER.createSignBlock("poise", EEProperties.POISE_WOOD_TYPE, EEProperties.POISE.sign());
