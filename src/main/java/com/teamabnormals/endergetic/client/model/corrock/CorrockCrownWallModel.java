...
public class CorrockCrownWallModel {
	...
	public CorrockCrownWallModel(ModelPart root) {
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition shape1 = root.addOrReplaceChild("shape1", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -16.0F, 0.0F, 16.0F, 16.0F, 0.0F, true), PartPose.offsetAndRotation(-8.0F, 16.0F, -7.0F, -0.6981317F, 0.0F, 0.0F));
		PartDefinition shape1_1 = root.addOrReplaceChild("shape1_1", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -16.0F, 0.0F, 16.0F, 16.0F, 0.0F, false), PartPose.offsetAndRotation(-8.0F, 16.0F, -7.0F, -0.34906584F, 0.0F, 0.0F));
