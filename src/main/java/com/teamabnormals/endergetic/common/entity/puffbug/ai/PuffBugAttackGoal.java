...
public class PuffBugAttackGoal extends Goal {
	...
	public boolean canUse() {
		...
		if (target == null) {
			return false;
		} else if (!PuffBug.CAN_ANGER.test(target)) {
			return false;
	...
	public boolean canContinueToUse() {
		...
		return this.puffbug.getLaunchDirection() == null && this.puffbug.getTarget() != null && PuffBug.CAN_ANGER.test(this.puffbug.getTarget());
	}
